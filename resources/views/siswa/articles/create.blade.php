...
@section('title', 'Tulis Karya Baru')
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            <div class="space-y-6 lg:col-span-2">
                <div class="card border-2 p-6 sm:p-8">
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title') }}" required class="field mt-2" placeholder="Judul karya kamu">
                    ...
                    <div class="mt-5">
                        ...
                        <textarea id="excerpt" name="excerpt" rows="2" maxlength="300" class="field mt-2" placeholder="Ringkasan singkat tentang karya kamu">{{ old('excerpt') }}</textarea>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <textarea id="body" name="body" rows="14" required class="field mt-2 font-mono text-[13px] leading-relaxed" placeholder="Tulis karya kamu di sini...">{{ old('body') }}</textarea>
            ...
            <div class="space-y-6">
                <div class="card border-2 p-6">
                    ...
                    <div class="mt-5">
                        <label class="label">Sampul <span class="font-normal normal-case text-ink-3">(opsional)</span></label>
                        <p class="mt-1 text-[11px] text-ink-3">Gambar sampul untuk menarik perhatian pembaca. Format JPG/PNG, maks 4MB.</p>
                        <label class="mt-2 flex cursor-pointer flex-col items-center justify-center gap-2 rounded-brutal border-2 border-dashed border-ink/30 bg-paper px-4 py-8 text-center transition-colors hover:border-ink">
